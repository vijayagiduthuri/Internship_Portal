...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Left Panel - Form */}
      <div className="w-full lg:w-2/5 bg-white flex items-center justify-center p-4 sm:p-6 lg:p-8 order-2 lg:order-1">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 sm:pl-12 pr-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full pl-10 sm:pl-12 pr-12 py-2.5 bg-gray-50 border border-gray-300 rounded-lg text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
            ...
            <div className="flex justify-center">
              <button 
                ...
                className="w-full cursor-pointer text-white font-bold shadow-md hover:scale-[1.02] sm:hover:scale-[1.05] shadow-purple-800 py-2.5 bg-gradient-to-bl from-purple-900 to-purple-900 rounded-md transition-transform duration-200"
              >
                Sign In
              </button>
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center py-2.5 px-4 border-2 border-purple-600 rounded-lg font-medium text-purple-600 bg-transparent hover:bg-purple-50 transition-all duration-200 hover:scale-[1.02] sm:hover:scale-105 active:scale-95"
              >
      ...
      <div className="w-full lg:w-3/5 flex flex-col justify-center items-center p-4 sm:p-6 lg:p-8 relative overflow-hidden min-h-[300px] sm:min-h-[400px] lg:min-h-screen order-1 lg:order-2" style={{ backgroundColor: '#620080' }}>
